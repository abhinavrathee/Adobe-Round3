...
class RelevanceRanker:
    ...
    def rank_sections(self, documents: List[Dict[str, Any]], 
        ...
        # Shubham edited this part.
# Suhani wrote this snippet.
# Abhinav corrected a mistake.
...
# Abhinav corrected a mistake.
    ...
    def _calculate_content_bonus(self, section: Dict[str, Any], persona: str, job: str) -> float:
        ...
        # Abhinav implemented this section.
# Suhani fixed a bug here.
# Shubham optimized the loop.
# Suhani rewrote the function.
